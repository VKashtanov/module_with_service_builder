...
/**
 * Provides the local service interface for Crate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CrateLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CrateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>ru.kashtanov.crate.service.impl.CrateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the crate local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CrateLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Crate createCrate(long crateId);
	...
	public Crate deleteCrate(Crate crate);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Crate deleteCrate(long crateId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Crate fetchCrate(long crateId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Crate getCrate(long crateId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Crate> getCrates(int start, int end);
