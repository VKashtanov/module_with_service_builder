...
/**
 * Provides the local service utility for Crate. This utility wraps
 * <code>ru.kashtanov.crate.service.impl.CrateLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CrateLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>ru.kashtanov.crate.service.impl.CrateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Crate addCrate(Crate crate) {
		return getService().addCrate(crate);
	}
	 ...
	 */
	public static Crate createCrate(long crateId) {
		return getService().createCrate(crateId);
	}
	 ...
	 */
	public static Crate deleteCrate(Crate crate) {
		return getService().deleteCrate(crate);
	}
	 ...
	 */
	public static Crate deleteCrate(long crateId) throws PortalException {
		return getService().deleteCrate(crateId);
	}
	...
	public static Crate fetchCrate(long crateId) {
		return getService().fetchCrate(crateId);
	}
	 ...
	 * @throws PortalException if a crate with the primary key could not be found
	 */
	public static Crate getCrate(long crateId) throws PortalException {
		return getService().getCrate(crateId);
	}
	 ...
	 */
	public static List<Crate> getCrates(int start, int end) {
		return getService().getCrates(start, end);
	}
	 ...
	 */
	public static int getCratesCount() {
		return getService().getCratesCount();
	}
	 ...
	 */
	public static Crate updateCrate(Crate crate) {
		return getService().updateCrate(crate);
	}

	public static CrateLocalService getService() {
		return _service;
	}

	public static void setService(CrateLocalService service) {
		_service = service;
	}

	private static volatile CrateLocalService _service;
